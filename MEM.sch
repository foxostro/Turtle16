...
U 1 1 5FAFBC3A
P 4650 5950
F 0 "#PWR0503" H 4650 5800 50  0001 C CNN
F 1 "VCC" H 4665 6123 50  0000 C CNN
...
U 1 1 5FAFC2D6
P 4650 7350
F 0 "#PWR0504" H 4650 7100 50  0001 C CNN
...
U 1 1 5FB1A8AC
P 4650 5150
F 0 "#PWR0502" H 4650 4900 50  0001 C CNN
...
U 1 1 5FB19FC6
P 4650 3350
F 0 "#PWR0501" H 4650 3200 50  0001 C CNN
...
$EndComp
$Comp
L Memory_RAM:CY62256-70PC U91
U 1 1 5FB189CF
P 4650 4250
F 0 "U91" H 4200 5250 50  0000 C CNN
F 1 "IS61C256AL-12TLI" H 4200 5150 50  0000 C CNN
F 2 "Package_SO:TSOP-I-28_11.8x8mm_P0.55mm" H 4650 4150 50  0001 C CNN
F 3 "https://www.mouser.com/datasheet/2/198/61C256AL-258651.pdf" H 4650 4150 50  0001 C CNN
	1    4650 4250
	1    0    0    -1  
$EndComp
...
$Comp
L MainBoard-rescue:ATF22V10C-Logic_Programmable U92
U 1 1 5FB18250
P 4650 6600
AR Path="/5FB18250" Ref="U92"  Part="1" 
AR Path="/60AF64DE/5FB18250" Ref="U92"  Part="1" 
F 0 "U92" H 4350 7300 50  0000 C CNN
...
The GAL controls the memory map for RAM.\nRAM will be mapped to [0x00FF, 0x7FFF].\nThe hole at the lower end of the address\nspace is reserved for memory mapped\nregisters for devices. The hole at the upper\nend of the address space is reserved for\nother devices such as video.
Wire Wire Line
	1200 7600 950  7600
$Comp
L power:GND #PWR?
U 1 1 5FB5A126
P 950 7700
AR Path="/5D2C0761/5FB5A126" Ref="#PWR?"  Part="1" 
AR Path="/5D2C0B92/5FB5A126" Ref="#PWR?"  Part="1" 
AR Path="/5FED3839/5FB5A126" Ref="#PWR?"  Part="1" 
AR Path="/60AF64DE/5FB5A126" Ref="#PWR0500"  Part="1" 
F 0 "#PWR0500" H 950 7450 50  0001 C CNN
...
U 1 1 5FB5A132
P 1200 7450
AR Path="/5D2C0761/5FB5A132" Ref="C?"  Part="1" 
AR Path="/5D2C0B92/5FB5A132" Ref="C?"  Part="1" 
AR Path="/5FED3839/5FB5A132" Ref="C?"  Part="1" 
AR Path="/60AF64DE/5FB5A132" Ref="C92"  Part="1" 
F 0 "C92" H 1315 7496 50  0000 L CNN
F 1 "100nF" H 1315 7405 50  0000 L CNN
F 2 "Capacitor_SMD:C_0603_1608Metric_Pad1.08x0.95mm_HandSolder" H 1238 7300 50  0001 C CNN
...
U 1 1 5FB5A138
P 700 7450
AR Path="/5D2C0761/5FB5A138" Ref="C?"  Part="1" 
AR Path="/5D2C0B92/5FB5A138" Ref="C?"  Part="1" 
AR Path="/5FED3839/5FB5A138" Ref="C?"  Part="1" 
AR Path="/60AF64DE/5FB5A138" Ref="C91"  Part="1" 
F 0 "C91" H 815 7496 50  0000 L CNN
F 1 "100nF" H 815 7405 50  0000 L CNN
F 2 "Capacitor_SMD:C_0603_1608Metric_Pad1.08x0.95mm_HandSolder" H 738 7300 50  0001 C CNN
...
U 1 1 5FB5A13F
P 950 7200
AR Path="/5D2C0761/5FB5A13F" Ref="#PWR?"  Part="1" 
AR Path="/5D2C0B92/5FB5A13F" Ref="#PWR?"  Part="1" 
AR Path="/5FED3839/5FB5A13F" Ref="#PWR?"  Part="1" 
AR Path="/60AF64DE/5FB5A13F" Ref="#PWR0499"  Part="1" 
F 0 "#PWR0499" H 950 7050 50  0001 C CNN
