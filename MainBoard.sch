...
F0 "Clock" 50
F1 "Clock.sch" 50
F2 "~HLT" I R 2250 1050 50 
F3 "~RDY" I L 1700 1050 50 
$EndSheet
$Sheet
S 8750 1450 1350 4650
U 5FED3839
F0 "ID" 50
F1 "ID.sch" 50
F2 "Z" I L 8750 3600 50 
F3 "Carry" I L 8750 3700 50 
F4 "Ins[0..15]" I L 8750 1750 50 
F5 "ControlWord[1..20]" O L 8750 4150 50 
F6 "OVF" I L 8750 3500 50 
F7 "InsOut[0..10]" O L 8750 4450 50 
F8 "~HLT" O R 10100 1550 50 
F9 "~WRH" I L 8750 5700 50 
F10 "~WRL" I L 8750 5800 50 
F11 "C[0..15]" I L 8750 5600 50 
F12 "SelC[0..2]" I L 8750 6000 50 
F13 "A[0..15]" O L 8750 4250 50 
F14 "B[0..15]" O L 8750 4350 50 
F15 "~WBEN" I L 8750 5900 50 
$EndSheet
$Comp
L power:VCC #PWR?
U 1 1 608FD908
...
$EndComp
$Sheet
S 1700 3950 1550 1000
U 60AF64DE
F0 "MEM" 50
F1 "MEM.sch" 50
F2 "StoreOpIn[0..15]" I R 3250 4650 50 
F3 "StoreOp[0..15]" O L 1700 4750 50 
F4 "ALUResult[0..15]" I R 3250 4850 50 
F5 "CtlIn[13..20]" I R 3250 4750 50 
F6 "Ctl[16..20]" O L 1700 4850 50 
F7 "~MemStore" T R 3250 4150 50 
F8 "~MemLoad" T R 3250 4250 50 
F9 "SystemBus[0..7]" T R 3250 4350 50 
F10 "Addr[0..15]" T R 3250 4450 50 
F11 "~RDY" I L 1700 4100 50 
$EndSheet
Wire Bus Line
	1700 4850 1600 4850
Wire Wire Line
...
Wire Bus Line
	3950 4850 6050 4850
$Sheet
S 4300 5400 1900 700 
U 60B264DC
F0 "WB" 50
F1 "WB.sch" 50
F2 "C[0..15]" O R 6200 5600 50 
F3 "ALUResultIn[0..15]" I L 4300 5600 50 
F4 "~WRH" O R 6200 5700 50 
F5 "~WRL" O R 6200 5800 50 
F6 "StoreOp[0..15]" I L 4300 6000 50 
F7 "CtlIn[16..20]" I L 4300 5900 50 
F8 "SelC[0..2]" O R 6200 6000 50 
F9 "SelCIn[0..2]" I L 4300 5500 50 
F10 "~WBEN" O R 6200 5900 50 
$EndSheet
Wire Bus Line
	1600 5900 4300 5900
Wire Bus Line
...
F0 "EX" 50
F1 "EX.sch" 50
F2 "ALUResult[0..15]" O L 6050 4850 50 
F3 "Ctl[13..20]" O L 6050 4750 50 
F4 "Z" O L 6050 4250 50 
F5 "Carry" O L 6050 4150 50 
F6 "OVF" O L 6050 4350 50 
F7 "~J" O L 6050 4450 50 
F8 "StoreOp[0..15]" O L 6050 4650 50 
F9 "SelC[0..2]" O L 6050 4950 50 
F10 "CtlIn[1..20]" I R 7400 4150 50 
F11 "PC[0..15]" I R 7400 4050 50 
F12 "Ins[0..10]" I R 7400 4450 50 
F13 "A[0..15]" I R 7400 4250 50 
F14 "B[0..15]" I R 7400 4350 50 
F15 "Offset[0..15]" O L 6050 4550 50 
$EndSheet
Wire Wire Line
	5600 4150 5600 3700
Wire Wire Line
...
F0 "IF" 50
F1 "IF.sch" 50
F2 "InsOut[0..15]" O R 7350 1750 50 
F3 "PCOut[0..15]" O R 7350 1850 50 
...
U 1 1 5FDA3B48
P 5000 7250
F 0 "#PWR08" H 5000 7000 50  0001 C CNN
...
U 1 1 5FDA3B3C
P 5000 6750
F 0 "#PWR07" H 5000 6500 50  0001 C CNN
