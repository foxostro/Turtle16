...
Wire Bus Line
	5400 1150 4200 1150
$Sheet
S 7150 1250 1300 700 
U 5FED3839
F0 "ID" 50
F1 "ID.sch" 50
F2 "Z" I L 7150 1750 50 
F3 "Carry" I L 7150 1850 50 
F4 "Ins[0..15]" I L 7150 1550 50 
F5 "ControlWord[0..19]" O R 8450 1850 50 
F6 "Phi1" I L 7150 1350 50 
F7 "OVF" I L 7150 1650 50 
$EndSheet
Wire Bus Line
	6750 1450 6850 1450
Wire Bus Line
...
F5 "SelCIn[0..2]" I R 5200 4450 50 
F6 "SelC[0..2]" O L 3650 4650 50 
F7 "Ctl[13..19]" O L 3650 4450 50 
F8 "CtlIn[12..19]" I R 5200 4550 50 
F9 "~J" O L 3650 4250 50 
$EndSheet
Wire Bus Line
	8800 4300 8600 4300
Wire Bus Line
...
F0 "REG/EX" 50
F1 "REG_EX.sch" 50
F2 "StoreOp[0..15]" O L 7200 4250 50 
F3 "StoreOpIn[0..15]" I R 8600 4300 50 
F4 "Phi1" I L 7200 4150 50 
F5 "SelCIn[0..2]" I R 8600 4400 50 
F6 "SelC[0..2]" O L 7200 4350 50 
F7 "CtlIn[5..19]" I R 8600 4500 50 
F8 "Ctl[5..19]" O L 7200 4450 50 
$EndSheet
Wire Wire Line
	5700 4050 5650 4050
Wire Wire Line
...
F3 "StoreOp[0..15]" O R 3100 5600 50 
F4 "StoreOpIn[0..15]" I L 1500 5700 50 
F5 "SelC[0..2]" O R 3100 5700 50 
F6 "CtlIn[15..19]" I L 1500 5600 50 
F7 "Ctl[15..19]" O R 3100 5500 50 
F8 "SelCIn[0..2]" I L 1500 5400 50 
$EndSheet
Wire Wire Line
	1300 5300 1500 5300
Wire Bus Line
...
F0 "EX" 50
F1 "EX.sch" 50
F2 "ALUResult[0..15]" O L 5700 4650 50 
F3 "Phi1" I L 5700 4050 50 
F4 "CtlIn[5..19]" I R 7000 4450 50 
F5 "Ctl[12..19]" O L 5700 4550 50 
F6 "RightOp[0..15]" I R 7000 4550 50 
F7 "LeftOp[0..15]" I R 7000 4650 50 
F8 "Z" O L 5700 4250 50 
F9 "Carry" O L 5700 4150 50 
F10 "OVF" O L 5700 4350 50 
$EndSheet
$Sheet
...
F4 "RightOp[0..15]" O L 8800 4600 50 
F5 "StoreOp[0..15]" O L 8800 4300 50 
F6 "PC[0..15]" I R 10000 4400 50 
F7 "Phi2" I R 10000 5700 50 
F8 "C[0..15]" I L 8800 5300 50 
F9 "SelCIn[0..2]" I L 8800 5600 50 
F10 "SelCOut[0..2]" O L 8800 4400 50 
F11 "Ins[0..10]" I R 10000 4500 50 
F12 "~HLT" O R 10000 4800 50 
F13 "CtlIn[0..19]" I R 10000 4300 50 
F14 "Ctl[5..19]" O L 8800 4500 50 
F15 "LeftOp[0..15]" O L 8800 4700 50 
$EndSheet
Wire Wire Line
	600  750  550  750 
Wire Wire Line
...
F6 "Phi2" I L 4150 5300 50 
F7 "StoreOp[0..15]" I L 4150 5600 50 
F8 "CtlIn[15..19]" I L 4150 5500 50 
F9 "Phi1" I L 4150 5200 50 
$EndSheet
Wire Bus Line
	8800 5600 6500 5600
Wire Bus Line
...
Wire Bus Line
	1500 5400 1150 5400
$Sheet
S 8850 1250 1150 450 
U 60153F0B
F0 "ID/REG" 50
F1 "ID_REG.sch" 50
F2 "PCIn[0..15]" I L 8850 1500 50 
F3 "Phi1" I L 8850 1350 50 
F4 "InsIn[0..15]" I L 8850 1600 50 
F5 "PCOut[0..15]" O R 10000 1600 50 
F6 "InsOut[0..10]" O R 10000 1500 50 
$EndSheet
$Sheet
...
Wire Bus Line
	6900 1550 6900 1050
Wire Bus Line
	8450 1850 10100 1850
Wire Bus Line
	10100 1850 10100 4300
Wire Wire Line
	8800 5400 6050 5400
Wire Wire Line
	3550 4150 3550 5200
