...
extension Computer {    
    public var stackPointer: Int {
        let stackPointerHi = Int(dataRAM.load(from: Int(IRToTurtleMachineCodeCompiler.kStackPointerAddressHi)))
        let stackPointerLo = Int(dataRAM.load(from: Int(IRToTurtleMachineCodeCompiler.kStackPointerAddressLo)))
    ...
    public var framePointer: Int {
        let framePointerHi = Int(dataRAM.load(from: Int(IRToTurtleMachineCodeCompiler.kFramePointerAddressHi)))
        let framePointerLo = Int(dataRAM.load(from: Int(IRToTurtleMachineCodeCompiler.kFramePointerAddressLo)))
