...
AR Path="/5FAED671/5FAF792A" Ref="#PWR0272"  Part="1" 
F 0 "#PWR0272" H 6250 2650 50  0001 C CNN
...
AR Path="/5FAED671/5FAF794C" Ref="#PWR0256"  Part="1" 
F 0 "#PWR0256" H 5650 1850 50  0001 C CNN
...
AR Path="/5FAED671/5FAF796F" Ref="#PWR0265"  Part="1" 
F 0 "#PWR0265" H 5650 4450 50  0001 C CNN
...
AR Path="/5FAED671/5FD376AD" Ref="#PWR0261"  Part="1" 
F 0 "#PWR0261" H 5650 3250 50  0001 C CNN
...
AR Path="/5FAED671/5FD395C1" Ref="#PWR0259"  Part="1" 
F 0 "#PWR0259" H 5650 2650 50  0001 C CNN
...
AR Path="/5FAED671/5FD3CC03" Ref="#PWR0260"  Part="1" 
F 0 "#PWR0260" H 5650 2950 50  0001 C CNN
...
AR Path="/5FAED671/5FD9B74C" Ref="#PWR0262"  Part="1" 
F 0 "#PWR0262" H 5650 3550 50  0001 C CNN
...
AR Path="/5FAED671/5FD9C7A1" Ref="#PWR0263"  Part="1" 
F 0 "#PWR0263" H 5650 3850 50  0001 C CNN
...
AR Path="/5FAED671/5FDAC894" Ref="#PWR0264"  Part="1" 
F 0 "#PWR0264" H 5650 4150 50  0001 C CNN
...
AR Path="/5FAED671/5FDB1D21" Ref="#PWR0278"  Part="1" 
F 0 "#PWR0278" H 6250 4450 50  0001 C CNN
...
AR Path="/5FAED671/5FDB4B0A" Ref="#PWR0269"  Part="1" 
F 0 "#PWR0269" H 6250 1850 50  0001 C CNN
...
AR Path="/5FAED671/5FDB4B18" Ref="#PWR0277"  Part="1" 
F 0 "#PWR0277" H 6250 4150 50  0001 C CNN
...
AR Path="/5FAED671/5FDBA759" Ref="#PWR0273"  Part="1" 
F 0 "#PWR0273" H 6250 2950 50  0001 C CNN
...
AR Path="/5FAED671/5FDBF023" Ref="#PWR0275"  Part="1" 
F 0 "#PWR0275" H 6250 3550 50  0001 C CNN
...
AR Path="/5FAED671/5FDC14FF" Ref="#PWR0276"  Part="1" 
F 0 "#PWR0276" H 6250 3850 50  0001 C CNN
...
AR Path="/5FAED671/5FDBCB4E" Ref="#PWR0274"  Part="1" 
F 0 "#PWR0274" H 6250 3250 50  0001 C CNN
...
U 1 1 5FBF62F4
P 6250 1600
F 0 "#PWR0266" H 6250 1450 50  0001 C CNN
...
U 1 1 5FBF6D31
P 5650 1600
F 0 "#PWR0253" H 5650 1450 50  0001 C CNN
...
AR Path="/5FAED671/5FBB7C05" Ref="#PWR0252"  Part="1" 
F 0 "#PWR0252" H 4100 600 50  0001 C CNN
...
AR Path="/5FAED671/5FBB7C0B" Ref="R47"  Part="1" 
F 0 "R47" H 4159 946 50  0000 L CNN
...
AR Path="/5FAED671/5FBBFEC5" Ref="U36"  Part="7" 
F 0 "U36" H -1250 6250 50  0000 C CNN
...
AR Path="/5FAED671/5FBBFECB" Ref="U36"  Part="6" 
F 0 "U36" H -950 5717 50  0000 C CNN
...
AR Path="/5FAED671/5FBBFED1" Ref="U36"  Part="5" 
F 0 "U36" H -950 5217 50  0000 C CNN
...
AR Path="/5FAED671/5FBBFED7" Ref="U36"  Part="4" 
F 0 "U36" H -950 4717 50  0000 C CNN
...
AR Path="/5FAED671/5FBBFEDD" Ref="U36"  Part="3" 
F 0 "U36" H -950 4217 50  0000 C CNN
...
AR Path="/5FAED671/5FBBFEE5" Ref="#PWR0250"  Part="1" 
F 0 "#PWR0250" H -1250 2700 50  0001 C CNN
...
AR Path="/5FAED671/5FBBFEF1" Ref="#PWR0251"  Part="1" 
F 0 "#PWR0251" H -1250 6600 50  0001 C CNN
...
AR Path="/5FAED671/5FBBFEFD" Ref="U36"  Part="2" 
F 0 "U36" H -950 3717 50  0000 C CNN
...
AR Path="/5FAED671/5FBCC32D" Ref="U36"  Part="1" 
F 0 "U36" H 4750 1367 50  0000 C CNN
...
AR Path="/5FAED671/5FBEF786" Ref="#PWR0271"  Part="1" 
F 0 "#PWR0271" H 6250 2350 50  0001 C CNN
...
AR Path="/5FAED671/5FBF251B" Ref="#PWR0268"  Part="1" 
F 0 "#PWR0268" H 6250 1650 50  0001 C CNN
...
AR Path="/5FAED671/5FBF51C5" Ref="#PWR0258"  Part="1" 
F 0 "#PWR0258" H 5650 2350 50  0001 C CNN
...
AR Path="/5FAED671/5FBF815A" Ref="#PWR0255"  Part="1" 
F 0 "#PWR0255" H 5650 1650 50  0001 C CNN
...
AR Path="/5FAED671/5FC39243" Ref="#PWR0257"  Part="1" 
F 0 "#PWR0257" H 5650 2050 50  0001 C CNN
...
AR Path="/5FAED671/5FC40EA5" Ref="#PWR0270"  Part="1" 
F 0 "#PWR0270" H 6250 2050 50  0001 C CNN
...
AR Path="/5FAED671/5FC4C3D9" Ref="#PWR0267"  Part="1" 
F 0 "#PWR0267" H 6250 1450 50  0001 C CNN
...
AR Path="/5FAED671/5FC4F660" Ref="#PWR0254"  Part="1" 
F 0 "#PWR0254" H 5650 1450 50  0001 C CNN
