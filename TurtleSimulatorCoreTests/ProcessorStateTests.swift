...
class ProcessorStateTests: XCTestCase {
    ...
    func testInitParameterized() {
        let cpuState = CPUStateSnapshot(uptime: UInt64.max,
                                      ...
                                      aluResultBuffer: Register(withValue: 0xff),
                                      aluResult: Register(withValue: 0xfb),
                                      aluFlagsBuffer: Flags(1, 0),
                                      aluFlags: Flags(1, 0),
                                      flags: Flags(0, 1),
        ...
        XCTAssertEqual(cpuState.aluResultBuffer, Register(withValue: 0xff))
        XCTAssertEqual(cpuState.aluResult, Register(withValue: 0xfb))
        XCTAssertEqual(cpuState.aluFlagsBuffer, Flags(1, 0))
...
registerU: 0xf9 --> 0x00
registerV: 0xfa --> 0x00
aluResultBuffer: 0xff --> 0x00
aluResult: 0xfb --> 0x00
aluFlagsBuffer: {carryFlag: 1, equalFlag: 0} --> {carryFlag: 0, equalFlag: 0}
aluFlags: {carryFlag: 1, equalFlag: 0} --> {carryFlag: 0, equalFlag: 0}
