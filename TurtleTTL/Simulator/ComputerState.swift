...
public class ComputerState: NSObject {
    ...
    public let registerG: Register // LinkHi
    public let registerH: Register // LinkLo
    ...
    public override convenience init() {
        self.init(withBus: Register(),
                  ...
                  withRegisterG: Register(),
                  withRegisterH: Register(),
    ...
    public required init(withBus bus: Register,
                         ...
                         withRegisterG registerG: Register,
                         withRegisterH registerH: Register,
    ...
    public func withRegisterG(_ registerG: UInt8) -> ComputerState {
        return ComputerState(withBus: bus,
                             withRegisterA: registerA,
                             withRegisterB: registerB,
                             withRegisterC: registerC,
                             withRegisterD: registerD,
                             withRegisterG: Register(withValue: registerG),
                             withRegisterH: registerH,
                             withRegisterX: registerX,
                             withRegisterY: registerY,
                             withRegisterU: registerU,
    ...
    public func withRegisterH(_ registerH: UInt8) -> ComputerState {
        return ComputerState(withBus: bus,
                             withRegisterA: registerA,
                             withRegisterB: registerB,
                             withRegisterC: registerC,
                             withRegisterD: registerD,
                             withRegisterG: registerG,
                             withRegisterH: Register(withValue: registerH),
                             withRegisterX: registerX,
                             withRegisterY: registerY,
                             withRegisterU: registerU,
                             withRegisterV: registerV,
