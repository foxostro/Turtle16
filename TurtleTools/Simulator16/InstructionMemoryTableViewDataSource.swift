...
class InstructionMemoryTableViewDataSource: NSObject, NSTableViewDataSource {
    ...
    public func tableView(_ tableView: NSTableView,
        ...
        case kColumnIdentifierZero:
            return String(format: "%04x", computer.instructions[row*16+0])
            
        case kColumnIdentifierOne:
            return String(format: "%04x", computer.instructions[row*16+1])
            
        case kColumnIdentifierTwo:
            return String(format: "%04x", computer.instructions[row*16+2])
            
        case kColumnIdentifierThree:
            return String(format: "%04x", computer.instructions[row*16+3])
            
        case kColumnIdentifierFour:
            return String(format: "%04x", computer.instructions[row*16+4])
            
        case kColumnIdentifierFive:
            return String(format: "%04x", computer.instructions[row*16+5])
            
        case kColumnIdentifierSix:
            return String(format: "%04x", computer.instructions[row*16+6])
            
        case kColumnIdentifierSeven:
            return String(format: "%04x", computer.instructions[row*16+7])
            
        case kColumnIdentifierEight:
            return String(format: "%04x", computer.instructions[row*16+8])
            
        case kColumnIdentifierNine:
            return String(format: "%04x", computer.instructions[row*16+9])
            
        case kColumnIdentifierA:
            return String(format: "%04x", computer.instructions[row*16+10])
            
        case kColumnIdentifierB:
            return String(format: "%04x", computer.instructions[row*16+11])
            
        case kColumnIdentifierC:
            return String(format: "%04x", computer.instructions[row*16+12])
            
        case kColumnIdentifierD:
            return String(format: "%04x", computer.instructions[row*16+13])
            
        case kColumnIdentifierE:
            return String(format: "%04x", computer.instructions[row*16+14])
            
        case kColumnIdentifierF:
            return String(format: "%04x", computer.instructions[row*16+15])
            
        case kColumnIdentifierText:
            let words = computer.instructions[(row*16)...(row*16+15)]
            var bytes: [UInt8] = []
            for word in words {
