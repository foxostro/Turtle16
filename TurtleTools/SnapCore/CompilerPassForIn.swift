...
public class CompilerPassForIn: CompilerPass {
    ...
    public override func visit(forIn node0: ForIn) throws -> AbstractSyntaxTreeNode? {
        ...
        let sequence = Expression.Identifier(sourceAnchor: node1.sourceAnchor, identifier: "__sequence")
        let index = Expression.Identifier(sourceAnchor: node1.sourceAnchor, identifier: "__index")
        let limit = Expression.Identifier(sourceAnchor: node1.sourceAnchor, identifier: "__limit")
