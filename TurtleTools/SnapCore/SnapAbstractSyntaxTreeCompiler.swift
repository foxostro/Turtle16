...
//    var staticStoragePointer = SnapCompilerMetrics.kStaticStorageStartAddress // TODO: assignment of concrete memory addresses should be done later in the compilation process, like, right before compiling to assembly code
