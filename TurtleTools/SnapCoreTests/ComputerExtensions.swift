...
extension Computer {    
    public var stackPointer: Int {
        let stackPointerHi = Int(dataRAM.load(from: Int(SnapCompilerMetrics.kStackPointerAddressHi)))
        let stackPointerLo = Int(dataRAM.load(from: Int(SnapCompilerMetrics.kStackPointerAddressLo)))
    ...
    public var framePointer: Int {
        let framePointerHi = Int(dataRAM.load(from: Int(SnapCompilerMetrics.kFramePointerAddressHi)))
        let framePointerLo = Int(dataRAM.load(from: Int(SnapCompilerMetrics.kFramePointerAddressLo)))
