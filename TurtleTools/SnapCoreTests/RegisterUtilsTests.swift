...
final class RegisterUtilsTests: XCTestCase {
    ...
    func testGetReferencedRegisters_LA() throws {
        let result = RegisterUtils.getReferencedRegisters(InstructionNode(instruction: kLA, parameters: [
    ...
    func testGetReferencedRegisters_ADD() throws {
        let result = RegisterUtils.getReferencedRegisters(InstructionNode(instruction: kADD, parameters: [
    ...
    func testGetSourceRegisters_LA() throws {
        let result = RegisterUtils.getSourceRegisters(InstructionNode(instruction: kLA, parameters: [
            ParameterIdentifier("r0"),
            ParameterIdentifier("foo")
        ]))
        XCTAssertTrue(result.isEmpty)
    ...
    func testGetSourceRegisters_ADD() throws {
        let result = RegisterUtils.getSourceRegisters(InstructionNode(instruction: kADD, parameters: [
            ParameterIdentifier("r2"),
            ParameterIdentifier("r1"),
            ParameterIdentifier("r0")
        ]))
    ...
    func testGetSourceRegisters_CMP() throws {
        let result = RegisterUtils.getSourceRegisters(InstructionNode(instruction: kCMP, parameters: [
            ParameterIdentifier("r1"),
            ParameterIdentifier("r0")
        ]))
        XCTAssertEqual(result, ["r0", "r1"])
    ...
    func testGetSourceRegisters_CMPI() throws {
        let result = RegisterUtils.getSourceRegisters(InstructionNode(instruction: kCMPI, parameters: [
            ParameterIdentifier("r0"),
            ParameterNumber(42)
        ]))
        XCTAssertEqual(result, ["r0"])
    ...
    func testGetDestinationRegisters_LA() throws {
        let result = RegisterUtils.getDestinationRegisters(InstructionNode(instruction: kLA, parameters: [
            ParameterIdentifier("r0"),
            ParameterIdentifier("foo")
        ]))
        XCTAssertEqual(result, ["r0"])
    ...
    func testGetDestinationRegisters_ADD() throws {
        let result = RegisterUtils.getDestinationRegisters(InstructionNode(instruction: kADD, parameters: [
            ParameterIdentifier("r2"),
            ParameterIdentifier("r1"),
            ParameterIdentifier("r0")
        ]))
    ...
    func testGetDestinationRegisters_CMP() throws {
        let result = RegisterUtils.getDestinationRegisters(InstructionNode(instruction: kCMP, parameters: [
            ParameterIdentifier("r1"),
            ParameterIdentifier("r0")
        ]))
