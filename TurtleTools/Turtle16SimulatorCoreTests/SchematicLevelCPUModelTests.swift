...
class SchematicLevelCPUModelTests: XCTestCase {
    ...
    func testStore() {
        ...
        cpu.instructions = [
            0b0000000000000000, // NOP
            0b0001111100101111 // STORE r3, r1, -1 -- 0bkkkkkiiiaaabbbii
        ]
    ...
    func testLi_signExtended() {
        ...
        cpu.instructions = [
            0b0000000000000000, // NOP
            0b0010001110000000  // LI r3, 65408
        ]
        cpu.reset()
        cpu.step() // -
        cpu.step() // IF
    ...
    func testLui() {
        ...
        cpu.instructions = [
            0b0000000000000000, // NOP
            0b0010101111001101  // LUI r3, 0xcd
        ]
        cpu.reset()
        cpu.step() // -
        cpu.step() // IF
    ...
    func testAnd() {
        ...
        cpu.instructions = [
            0b0000000000000000, // NOP
            0b0100100000101000  // AND r0, r1, r2
        ]
        cpu.setRegister(0, 0)
    ...
    func testOr() {
        ...
        cpu.instructions = [
            0b0000000000000000, // NOP
            0b0101000000101000  // OR r0, r1, r2
        ]
        cpu.setRegister(0, 0)
        cpu.setRegister(1, 0xabcd)
        cpu.setRegister(2, 0xf0f0)
    ...
    func testAddi() {
        ...
        cpu.instructions = [
            0b0000000000000000, // NOP
            0b0111000000100010, // ADDI r0, r1, 2
        ]
        cpu.setRegister(0, 0xabcd)
        cpu.setRegister(1, 0xffff)
        cpu.reset()
    ...
    func testSubi() {
        ...
        cpu.instructions = [
            0b0000000000000000, // NOP
            0b0111100000100001  // SUBI r0, r1, 1
        ]
        cpu.setRegister(0, 0xabcd)
        cpu.setRegister(1, 0)
        cpu.reset()
    ...
    func testAndi() {
        ...
        cpu.instructions = [
            0b0000000000000000, // NOP
            0b1000000000101111  // ANDI r0, r1, 15
        ]
        cpu.setRegister(0, 0xabcd)
        cpu.setRegister(1, 0xffff)
        cpu.reset()
    ...
    func testOri() {
        ...
        cpu.instructions = [
            0b0000000000000000, // NOP
            0b1000100000101111  // ORI r0, r1, 15
        ]
        cpu.setRegister(0, 0xabcd)
    ...
    func testXori() {
        ...
        cpu.instructions = [
            0b0000000000000000, // NOP
            0b1001000000101010  // XORI r0, r1, 10
        ]
        cpu.setRegister(0, 0xabcd)
