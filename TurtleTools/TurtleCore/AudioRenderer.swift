...
private func callback(
    ...
    let opaqueContext: UnsafeMutablePointer<AudioRenderer> = inRefCon.assumingMemoryBound(
        to: AudioRenderer.self
    )
    let context: AudioRenderer = Unmanaged<AudioRenderer>.fromOpaque(opaqueContext)
        .takeUnretainedValue()
