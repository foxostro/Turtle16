...
struct DisassemblyView: NSViewRepresentable {
    ...
    func makeNSView(context: Context) -> NSScrollView {
        ...
        addressColumn.title = NSLocalizedString("Address", comment: "Address of the disassembled instruction")
        ...
        mnemonicColumn.title = NSLocalizedString("Mnemonic", comment: "The mnemonic of the disassembled instruction")
    ...
    func updateNSView(_ scrollView: NSScrollView, context: Context) {
        ...
        tableView.selectRowIndexes(IndexSet(integer: Int(viewModel.pc)), byExtendingSelection: false)
    }
