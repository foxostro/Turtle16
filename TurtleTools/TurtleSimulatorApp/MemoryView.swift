    ...
    struct HexDataView: NSViewRepresentable {
        ...
        func makeNSView(context: Context) -> NSScrollView {
            ...
            addressColumn.title = NSLocalizedString(
                "Address",
                comment: "Label for the Address column of the hex data table"
            )
            ...
            textColumn.title = NSLocalizedString(
                "Text",
                comment: "Label for the Text column of the hex data table"
            )
        ...
        VStack {
            HStack {
                Picker(
                    NSLocalizedString(
                        "Address Space:",
                        comment: "Label for the address space picker"
                    ),
