...
public struct ATF22V10 {
    ...
    fileprivate static func makeSingleProductTerms(
        _ defs: [Int],
        _ fuseList: [UInt]
    ) -> [ProductTermFuseMap] {
    ...
    fileprivate static func makeProductTerms(
        _ defs: [(Int, Int)],
        _ fuseList: [UInt]
    ) -> [[ProductTermFuseMap]] {
