...
public final class AssemblerSingleInstructionCodeGenerator {
    ...
    private func makeInstructionRRR(opcode: Int, c: Register, a: Register, b: Register) throws -> UInt16 {
    ...
    private func makeInstructionRRI(opcode: Int, c: Register, a: Register, imm: Int) throws -> UInt16 {
        if imm > 15 {
            throw CompilerError(
    ...
    private func makeInstructionIRR(opcode: Int, a: Register, b: Register, imm: Int) throws -> UInt16 {
        if imm > 15 {
    ...
    public func load(_ destination: Register, _ source: Register, _ offset: Int) throws -> UInt16 {
        try makeInstructionRRI(opcode: DecoderGenerator.opcodeLoad, c: destination, a: source, imm: offset)
    }
    ...
    public func jr(_ destination: Register, _ offset: Int) throws -> UInt16 {
        try makeInstructionRRI(opcode: DecoderGenerator.opcodeJr, c: .r0, a: destination, imm: offset)
    }
    
    public func jalr(_ link: Register, _ destination: Register, _ offset: Int) throws -> UInt16 {
        try makeInstructionRRI(opcode: DecoderGenerator.opcodeJalr, c: link, a: destination, imm: offset)
    }
