...
public struct DecoderGenerator {
    ...
    public func generate() -> [UInt] {
        var controlWords = [UInt](repeating: ID.nopControlWord_ID, count: 512)
                ...
                for z in bits {
                    for v in bits {
                        makeControlWord(
                            ...
                            signals: signalsForRelativeJump
                        )
                        makeControlWord(
                            &controlWords,
                            index: makeIndex(
                        ...
                        if (n == 0 && v == 1) || (n == 1 && v == 0) {
                            makeControlWord(
                                ...
                                index: makeIndex(
                                    ...
                                    z: z,
                                    v: v,
                                    opcode: DecoderGenerator.opcodeBlt
                                ),
                                signals: signalsForRelativeJump
                            )
                        }
                        ...
                        if z == 0, (n == 0 && v == 0) || (n == 1 && v == 1) {
                            makeControlWord(
                                ...
                                index: makeIndex(
                                    ...
                                    z: z,
                                    v: v,
                                    opcode: DecoderGenerator.opcodeBgt
                                ),
                                signals: signalsForRelativeJump
                            )
                        }
                        ...
                        if c == 0 {
                            makeControlWord(
                                ...
                                index: makeIndex(
                                    ...
                                    z: z,
                                    v: v,
                                    opcode: DecoderGenerator.opcodeBltu
                                ),
                                signals: signalsForRelativeJump
                            )
                        }
                        ...
                        if c == 1, z == 0 {
                            makeControlWord(
                                ...
                                index: makeIndex(
                                    ...
                                    z: z,
                                    v: v,
                                    opcode: DecoderGenerator.opcodeBgtu
                                ),
                                signals: signalsForRelativeJump
                            )
                        }
