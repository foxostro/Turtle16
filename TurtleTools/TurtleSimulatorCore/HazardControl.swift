...
public class HazardControl {
    ...
    public func step(
        ...
        let stageOneInput = StageOneInput(
            sel_a_matches_sel_c_ex: sel_a_matches_sel_c_ex,
        ...
        let stageTwoInput = StageTwoInput(
            j: input.j,
