...
public class ID: NSObject, NSSecureCoding {
    ...
    public func step(input: Input) -> ID_Output {
        ...
        let hazardControlSignals = hazardControlUnit.step(
            input: input,
        ...
        return ID_Output(
            stall: hazardControlSignals.stall & 1,
            ctl_EX: ctl_EX,
            a: a,
            b: b,
            ins: ins,
    ...
    public func readRegisterA(input: Input) -> UInt16 {
        registerFile[Int(splitOutSelA(input: input))]
    }

    public func readRegisterB(input: Input) -> UInt16 {
        registerFile[Int(splitOutSelB(input: input))]
    }

    public func splitOutSelA(input: Input) -> UInt {
        UInt((input.ins >> 5) & 0b111)
    }

    public func splitOutSelB(input: Input) -> UInt {
        UInt((input.ins >> 2) & 0b111)
    }
}
