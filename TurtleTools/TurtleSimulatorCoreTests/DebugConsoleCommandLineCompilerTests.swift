...
final class DebugConsoleCommandLineCompilerTests: XCTestCase {
    ...
    func testResetTakesZeroOrOneParameter() throws {
        ...
        XCTAssertEqual(
            ...
            "instruction takes zero or one parameters: `reset'"
        )
    ...
    func testResetOtherIdentifier() throws {
        ...
        XCTAssertEqual(
            compiler.errors.first?.message,
            "expected parameter to specify either a `soft' or `hard' reset: `foo'"
        )
    ...
    func testResetOtherTypeOfParameter() throws {
        ...
        XCTAssertEqual(
            compiler.errors.first?.message,
            "expected parameter to specify either a `soft' or `hard' reset: `1'"
        )
    ...
    func testReadMemoryWithX_ExpectsAtLeastOneParameter() throws {
        ...
        XCTAssertEqual(
            compiler.errors.first?.message,
            "expected at least one parameter for the memory address: `x'"
        )
    ...
    func testReadMemoryWithX_WithLengthAndNoAddress() throws {
        ...
        XCTAssertEqual(
            compiler.errors.first?.message,
            "expected a number for the memory address: `x'"
        )
    ...
    func testReadMemoryWithAddressTooLarge() throws {
        ...
        XCTAssertEqual(
            compiler.errors.first?.message,
            "not enough bits to represent the passed value: `x'"
        )
    ...
    func testWriteMemoryWithZeroParameters() throws {
        ...
        XCTAssertEqual(
            compiler.errors.first?.message,
            "expected a memory address and data words: `writemem'"
        )
    ...
    func testWriteMemoryWithBadDataWord1() throws {
        ...
        XCTAssertEqual(
            compiler.errors.first?.message,
            "expected a number for the data word: `writemem'"
        )
    ...
    func testWriteMemoryWithBadDataWord2() throws {
        ...
        XCTAssertEqual(
            compiler.errors.first?.context,
            "\twritemem 0 0xffff foo\n\t                  ^~~"
        )
    }
    ...
    func testWriteMemoryWithBadBaseAddress2() throws {
        ...
        XCTAssertEqual(
            compiler.errors.first?.message,
            "expected a number for the memory address: `writemem'"
        )
    ...
    func testWriteMemoryWithBadDataWord_TooBig() throws {
        ...
        XCTAssertEqual(
            compiler.errors.first?.message,
            "not enough bits to represent the passed value: `writemem'"
        )
    ...
    func testInfoWithMoreThanOneParameter() throws {
        ...
        XCTAssertEqual(
            compiler.errors.first?.message,
            "instruction takes zero or one parameters: `info'"
        )
    ...
    func testReadInstructionMemoryWithX_ExpectsAtLeastOneParameter() throws {
        ...
        XCTAssertEqual(
            compiler.errors.first?.message,
            "expected at least one parameter for the memory address: `xi'"
        )
    ...
    func testReadInstructionMemoryWithX_WithLengthAndNoAddress() throws {
        ...
        XCTAssertEqual(
            compiler.errors.first?.message,
            "expected a number for the memory address: `xi'"
        )
    ...
    func testWriteInstructionMemoryWithZeroParameters() throws {
        ...
        XCTAssertEqual(
            compiler.errors.first?.message,
            "expected a memory address and data words: `writememi'"
        )
    ...
    func testWriteInstructionMemoryWithBadDataWord1() throws {
        ...
        XCTAssertEqual(
            compiler.errors.first?.message,
            "expected a number for the data word: `writememi'"
        )
    ...
    func testWriteInstructionMemoryWithBadDataWord_TooBig() throws {
        ...
        XCTAssertEqual(
            compiler.errors.first?.message,
            "not enough bits to represent the passed value: `writememi'"
        )
        XCTAssertEqual(
            compiler.errors.first?.context,
            "\twritememi 0 0x10000\n\t            ^~~~~~~"
    ...
    func testContinueTakesNoParameters() throws {
        ...
        XCTAssertEqual(
            compiler.errors.first?.message,
            "instruction takes no parameters: `continue'"
        )
    ...
    func testLoadWithNoParameters() throws {
        ...
        XCTAssertEqual(
            compiler.errors.first?.message,
            "expected one parameter for the destination and one parameter for the file path: `load'"
        )
    ...
    func testLoadWithIncorrectTypeForDestinationParameter() throws {
        ...
        XCTAssertEqual(
            compiler.errors.first?.message,
            "expected an identifier for the destination: `load'"
        )
    ...
    func testLoadWithIncorrectTypeForFilePathParameter() throws {
        ...
        XCTAssertEqual(
            compiler.errors.first?.message,
            "expected a string for the file path: `load'"
        )
    ...
    func testSaveWithNoParameters() throws {
        ...
        XCTAssertEqual(
            compiler.errors.first?.message,
            "expected one parameter for the source and one parameter for the file path: `save'"
        )
    ...
    func testSaveWithIncorrectTypeForSourceParameter() throws {
        ...
        XCTAssertEqual(
            compiler.errors.first?.message,
            "expected an identifier for the source: `save'"
        )
    ...
    func testSaveWithIncorrectTypeForFilePathParameter() throws {
        ...
        XCTAssertEqual(
            compiler.errors.first?.message,
            "expected a string for the file path: `save'"
        )
    ...
    func testDisassembleWithTooManyParameters() throws {
        ...
        XCTAssertEqual(
            compiler.errors.first?.message,
            "expected zero, one, or two parameters: `disassemble'"
        )
    ...
    func testDisassembleWithOneParameterExpectsStartAddress_FailsForString() throws {
        ...
        XCTAssertEqual(
            compiler.errors.first?.message,
            "expected an identifier or number for the base address: `disassemble'"
        )
    ...
    func testDisassembleWithOneParameterExpectsBaseAddress_MustBePositive() throws {
        ...
        XCTAssertEqual(
            compiler.errors.first?.message,
            "base address must not be negative: `disassemble'"
        )
    ...
    func testDisassembleWithOneParameterExpectsBaseAddress_MustBeLessThan65536() throws {
        ...
        XCTAssertEqual(
            compiler.errors.first?.message,
            "base address must be less than 65536: `disassemble'"
        )
    ...
    func testDisassembleWithTwoParametersExpectsCount_FailsForIdentifier_2() throws {
        ...
        XCTAssertEqual(
            compiler.errors.first?.message,
            "expected a number for the count: `disassemble'"
        )
        XCTAssertEqual(
            compiler.errors.first?.context,
            "\tdisassemble 123 foo\n\t                ^~~"
    ...
    func testDisassembleWithOneParameterExpectsCount_MustBeLessThan65536() throws {
        ...
        XCTAssertEqual(
            compiler.errors.first?.message,
            "count must be less than 65536: `disassemble'"
        )
        XCTAssertEqual(
            compiler.errors.first?.context,
            "\tdisassemble 0 65536\n\t              ^~~~~"
