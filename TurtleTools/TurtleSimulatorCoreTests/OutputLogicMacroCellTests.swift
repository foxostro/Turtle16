...
final class OutputLogicMacroCellTests: XCTestCase {
    ...
    func testActiveHighOutput() throws {
        ...
        let result = cell.step(Input(inputs: [UInt](repeating: 0, count: 24)))
    ...
    func testDisableOutput() throws {
        let cell = OutputLogicMacroCell(
            oe: ProductTermFuseMap(fuseListBitmap: 0),
            productTermFuseMaps: [ProductTermFuseMap(fuseListBitmap: 0)],
            s0: 1,
            s1: 1
        )
    ...
    func testRegisteredOutput() throws {
        ...
        let cell = OutputLogicMacroCell(
            ...
            productTermFuseMaps: [
                ProductTermFuseMap(
                    fuseListBitmap: 0b1111_01111111_11111111_11111111_11111111_11111111
                )
            ],
            s0: 1,
            s1: 0
    ...
    func testFlipFlopToggle() throws {
        ...
        let cell = OutputLogicMacroCell(
            ...
            productTermFuseMaps: [
                ProductTermFuseMap(
                    fuseListBitmap: 0b1110_11111111_11111111_11111111_11111111_11111111
                )
            ],
            s0: 1,
            s1: 0
