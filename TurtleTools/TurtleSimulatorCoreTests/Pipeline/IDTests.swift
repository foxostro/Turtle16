...
final class IDTests: XCTestCase {
    ...
    func testReadRegisterA() throws {
        ...
        let output = id.step(input: ID.Input(ins: 0b00000000_11100000))
    ...
    func testReadRegisterB() throws {
        let id = ID()
        id.registerFile[7] = 0xabcd
        let output = id.step(input: ID.Input(ins: 0b00000000_00011100))
